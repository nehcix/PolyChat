	...
	constructor(messagesObserver, channelsObserver) {
		...
		this.sock.onmessage = function(event) {
			...
			switch (this.lastAnswerFromServer.eventType) {
				case "onMessage":
					this.messagesObserver_.onMessage(this.lastAnswerFromServer, this.userName);
					break;
				...
				case "updateChannelsList":
					this.channelsObserver_.updateChannelsList(this.lastAnswerFromServer);
					break;
				case "onError":
				...
				case "onGetChannel":
					...
					for (let i = 0; i < this.lastAnswerFromServer.data.messages.length; ++i) {
						this.messagesObserver_.onMessage(
